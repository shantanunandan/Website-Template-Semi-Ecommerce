...
<title>Subhanpur Contact</title>
<script src="js/ajax1_contact.js" type="text/javascript"></script>
<script src="js/ajax2_contact.js" type="text/javascript"></script>
<script src="js/ajax3_contact.js" type="text/javascript"></script>
<link href="css/bootstrap_validate_contact.css" type="text/css" rel="stylesheet"></link>
<script src="js/boot_contact.js" type="text/javascript"></script>
<style type="text/css"></style>
<script src="js/newJS_contact.js" type="text/javascript"></script>
<style>
body {
    background: white;
}
